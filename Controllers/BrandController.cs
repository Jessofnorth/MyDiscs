...
namespace MyDiscs.Controllers
{
    ...
    public class BrandController : Controller
    {
        ...
        public BrandController(MydiscContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Brands != null ?
                        ...
                        Problem("Entity set 'MydiscContext.Brands'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MydiscContext.Brands'  is null.");
            }
            var brand = await _context.Brands.FindAsync(id);
            if (brand != null)
            {
        ...
        public async Task<IActionResult> Search(string searchString)
        {
            ...
            var brand = await _context.Brands
                .Where(b => b.BrandName.ToLower().Contains(searchString.ToLower()))
                .ToListAsync();
